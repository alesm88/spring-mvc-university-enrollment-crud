...
INSERT INTO subjects (name, description, timetable, max_quota, id_professor) VALUES('Programming', 'Learning the concepts of programming language', 'Monday 08:00', '20', null);
INSERT INTO subjects (name, description, timetable, max_quota, id_professor) VALUES('Mathematics', 'Knowing the basics of trigonometry, logarithms and more', 'Friday 08:00', '15', null);
INSERT INTO subjects (name, description, timetable, max_quota, id_professor) VALUES('English', 'Focusing on the development of reading, writing, speaking and listening skills', 'Friday 08:00', '5', null);
INSERT INTO subjects (name, description, timetable, max_quota, id_professor) VALUES('Philosophy', 'Study of fundamental questions and concepts that shape human understanding of existence, knowledge, values, reason, mind, and language', 'Tuesday 10:00', '0', null);
